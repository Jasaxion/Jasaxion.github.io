...
>
> > ![image-20210719200553342](./Luogu.assets/image-20210719200553342.png)我们需要以中间为基准，找半径为d，x轴的距离与中间mid最接近的点，创建一个数组 strip[]来存储所有像这样的点
>
...
> ![image-20210723100600736](./Luogu.assets/image-20210723100600736.png)
...
> > ![image-20210724114334069](./Luogu.assets/image-20210724114334069.png)
